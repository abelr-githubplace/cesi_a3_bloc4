...
namespace EasySaveLibrary.Tests
{
    ...
    public class Saver_SaverShould
    {
        ...
        public void Constructor_DirectorySource_IndexesEveryFile()
        {
            ...
            var saver = new Saver.Saver(Info("Job", _src, _dst), SaveType.Complete, new Progress(), _config, new SaveInterrupt.Pauser(), new SaveInterrupt.Stopper());
        ...
        public void Constructor_FileSource_HandlesSingleFile()
        {
            ...
            var saver = new Saver.Saver(Info("Job", lone, _dst), SaveType.Complete, new Progress(), _config, new SaveInterrupt.Pauser(), new SaveInterrupt.Stopper());
        ...
        public void Constructor_MissingSource_LeavesEmptyJobList()
        {
            ...
            var saver = new Saver.Saver(Info("Job", missing, _dst), SaveType.Complete, new Progress(), _config, new SaveInterrupt.Pauser(), new SaveInterrupt.Stopper());
        ...
        public void Start_CompleteSave_CopiesFilesAndPushesProgressToHundred()
        {
            ...
            var saver = new Saver.Saver(Info("Job", _src, _dst), SaveType.Complete, progress, _config, new SaveInterrupt.Pauser(), new SaveInterrupt.Stopper());
